...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/platForm/save"   enctype="multipart/form-data" >
			...
			<div
				...
				<div class="controls">
					<input type="text" name="pfId" class="input-large "/>
				</div>
			</div>	
			<div
				class="control-group">
				...
				<div class="controls">
					<input type="text" name="pfName" class="input-large "/>
				</div>
			</div>	
