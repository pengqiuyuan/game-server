...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/enumFunction/save"   enctype="multipart/form-data" >
			...
			<div
				...
				<div class="controls">
					<input type="text" name="enumRole" class="input-large "  />
				</div>
			</div>	
			<div
				class="control-group">
				...
				<div class="controls">
					<input type="text" name="enumName" class="input-large "  />
				</div>
			</div>	
