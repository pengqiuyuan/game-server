...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/gm/kds/gag/save"   enctype="multipart/form-data" >
			...
			<div class="form-actions">
				...
				<a href="${ctx}/manage/gm/kds/gag/index" class="btn btn-primary">返回</a>
			</div>
