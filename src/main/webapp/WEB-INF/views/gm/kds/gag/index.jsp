...
<body>
	...
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/kds/gag/index">
		...
		<div class="control-group">
								...
								<td><huake:getTimestampTag id="${item.gagEnd}"></huake:getTimestampTag></td>
			   					<td>
									<div class="action-buttons">
										<shiro:hasAnyRoles name="admin,kds_gm_gag_update">
										...
										<shiro:hasAnyRoles name="admin,kds_gm_gag_delete">
				...
				<div class="form-actions">
					<shiro:hasAnyRoles name="admin,kds_gm_gag_add">
						<a href="${ctx}/manage/gm/kds/gag/add" class="btn btn-primary">新增禁言</a>
					</shiro:hasAnyRoles>
				</div>
		</div>
		...
		<form id="inputForm" method="post" Class="form-horizontal" action="<%=request.getContextPath()%>/manage/gm/kds/gag/update"   enctype="multipart/form-data"  style="display: none;">
	...
	<script type="text/javascript">
			...
			function delGag(guid,gameId,serverZoneId,serverId){
				if(confirm("该操作会删除。。。。！"))
				    {
							$.ajax({
								url: '<%=request.getContextPath()%>/manage/gm/kds/gag/del?guid='+guid+'&gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId, 
								type: 'DELETE',
