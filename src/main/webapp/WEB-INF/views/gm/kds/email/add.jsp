...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/gm/kds/email/save"   enctype="multipart/form-data" >
			...
			<div class="form-actions">
				...
				<!-- 
				<a href="${ctx}/manage/gm/kds/email/index" class="btn btn-primary">返回</a>
				 -->
	...
	$(function(){
		$("#serverZoneId").change(function(e){
			...
			if($("#gameId").val()!=""){
				...
				$("#platFormDiv").empty();
				$.ajax({                                               
					url: '<%=request.getContextPath()%>/manage/gm/kds/serverStatus/findPlatForms?serverZoneId='+serverZoneId+'&gameId='+gameId, 
					type: 'GET',
					contentType: "application/json;charset=UTF-8",		
					dataType: 'text',
					success: function(data){
