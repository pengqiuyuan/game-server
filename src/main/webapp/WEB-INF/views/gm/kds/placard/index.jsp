...
<body>
	...
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/kds/placard/index">
		...
		<div class="control-group">
				...
				<div class="form-actions">
					<shiro:hasAnyRoles name="admin,kds_gm_placard_add">
					  	<a href="${ctx}/manage/gm/kds/placard/add" class="btn btn-primary">新增公告</a>
					</shiro:hasAnyRoles>
				</div>
		</div>
		...
		<form id="inputForm" method="post" Class="form-horizontal" action="<%=request.getContextPath()%>/manage/gm/kds/placard/update"   enctype="multipart/form-data"  style="display: none;">
	...
	<script type="text/javascript">
			...
			function delPlacard(id,gameId,serverZoneId,serverId){
				if(confirm("该操作会删除。。。。！"))
				    {
							$.ajax({
								url: '<%=request.getContextPath()%>/manage/gm/kds/placard/del?id='+id+'&gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId, 
								type: 'DELETE',
								contentType: "application/json;charset=UTF-8",
								dataType: 'json',
								success: function(data){
