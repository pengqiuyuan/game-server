...
<body>
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/kds/serverStatus/index">
		...
		<form id="inputForm" method="post" Class="form-horizontal" action="<%=request.getContextPath()%>/manage/gm/kds/serverStatus/update"   enctype="multipart/form-data" >
			<div class="control-group">
			...
			<shiro:hasAnyRoles name="admin,kds_gm_server_edit">
