...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/gm/kds/serverStatus/accountSave"   enctype="multipart/form-data" >
			...
			<div
 			...
 			<div class="form-actions">
				 ...
				 <a href="<%=request.getContextPath()%>/manage/gm/kds/serverStatus/accountIndex" class="btn btn-primary">返回</a>
	        </div>
	</form>
