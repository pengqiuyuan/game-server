...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/gm/fb/serverStatus/accountUpdate"   enctype="multipart/form-data" >
			...
			<div
				...
				<div class="controls">
					<input type="text" name="serverId" class="input-large " value="${account.serverId}"/>
				</div>
			</div>	
			<div
				class="control-group">
				...
				<div class="controls">
					<input type="text" name="platFormId" class="input-large "  value="${account.platFormId}"/>
				</div>
			</div>	
			<div
				class="control-group">
				...
				<div class="controls">
					<input type="text" name="account" class="input-large " value="${account.account}"/>
				</div>
			</div>	
