	...
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/fb/product/index">
				...
				<div
					class="control-group">
					<label class="control-label" for="search_EQ_itemId">道具ID：</label>
					<div class="controls">
						<input name="search_EQ_itemId" id="itemDiv" type="text" value="${param.search_EQ_itemId}" class="input-large "  placeholder="道具ID"/> 
					</div>
				</div>
