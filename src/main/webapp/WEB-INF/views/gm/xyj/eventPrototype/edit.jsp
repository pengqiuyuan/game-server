			...
			<div class="row">
				...
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="eventPic" id="eventPic" class="input-large " value="${eventPrototype.eventPic}"  ${eventPrototype.eventType == 13 ? '' : 'readonly="readonly"' } placeholder="如：huodong_icon_tongyong.png"/>
						</div>
					</div>
				</div>
				<div class="span6">
			...
			<div class="row">
				...
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="activeDelay" id="activeDelay" class="input-large " value="${eventPrototype.activeDelay}" placeholder="单位小时，如：1"/>
						</div>
					</div>
				</div>
				<div class="span6">
