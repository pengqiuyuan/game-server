...
<body>
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/xyj/serverStatus/index">
		...
		<form id="inputForm" method="post" Class="form-horizontal" action="<%=request.getContextPath()%>/manage/gm/xyj/serverStatus/update"   enctype="multipart/form-data" >
			<div class="control-group">
			...
			<shiro:hasAnyRoles name="admin,xyj_gm_server_edit">
