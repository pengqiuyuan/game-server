...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/gm/xyj/serverStatus/accountSave"   enctype="multipart/form-data" >
			...
			<div
 			...
 			<div class="form-actions">
				 ...
				 <a href="<%=request.getContextPath()%>/manage/gm/xyj/serverStatus/accountIndex" class="btn btn-primary">返回</a>
	        </div>
	</form>
