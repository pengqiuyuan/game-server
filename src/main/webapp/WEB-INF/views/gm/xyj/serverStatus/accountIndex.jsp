...
<body>
	...
	<script type="text/javascript">
		...
		function delAccount(gameId,serverZoneId,serverId,platForm,account){
		    ...
		    {
				$.ajax({
					url: '<%=request.getContextPath()%>/manage/gm/xyj/serverStatus/accountDel?gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId+'&platForm='+platForm+'&account='+account,
					type: 'DELETE',
