...
<body>
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/xyj/serverStatus/accountIndex">
					...
					<tr id="${item.id}">
						...
						<td>
							<div class="action-buttons">
								<shiro:hasAnyRoles name="admin,xyj_gm_account_update">
								...
								<shiro:hasAnyRoles name="admin,xyj_gm_account_delete">
		...
		<div class="form-actions">
 			<shiro:hasAnyRoles name="admin,xyj_gm_account_add">
  			    <a href="<%=request.getContextPath()%>/manage/gm/xyj/serverStatus/accountAdd" class="btn btn-primary">新增灰度帐号</a>
  			</shiro:hasAnyRoles>
	    </div>
	</div>
	
	<form id="inputForm" method="post" Class="form-horizontal" action="<%=request.getContextPath()%>/manage/gm/xyj/serverStatus/accountUpdate"   enctype="multipart/form-data"  style="display: none;">
	...
	<script type="text/javascript">
		...
		function delAccount(id,gameId,serverZoneId,serverId,platForm,account){
		    ...
		    {
				$.ajax({
					url: '<%=request.getContextPath()%>/manage/gm/xyj/serverStatus/accountDel?id='+id+'&gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId+'&platForm='+platForm+'&account='+account,
					type: 'DELETE',
