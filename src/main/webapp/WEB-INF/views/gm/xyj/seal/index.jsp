...
<body>
	...
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/xyj/seal/index">
	...
	<script type="text/javascript">
			...
			function delSeal(guid,gameId,serverZoneId,serverId){
				if(confirm("该操作会删除。。。。！"))
				    {
							$.ajax({
								url: '<%=request.getContextPath()%>/manage/gm/xyj/seal/del?guid='+guid+'&gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId, 
								type: 'DELETE',
