...
<body>
	...
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/xyj/placard/index">
								...
								<c:choose> 
			   					...
			   					<td>
									<div class="action-buttons">
										<shiro:hasAnyRoles name="admin,xyj_gm_placard_update">
										...
										<shiro:hasAnyRoles name="admin,xyj_gm_placard_delete">
		...
		<form id="inputForm" method="post" Class="form-horizontal" action="<%=request.getContextPath()%>/manage/gm/xyj/placard/update"   enctype="multipart/form-data"  style="display: none;">
	...
	<script type="text/javascript">
			...
			function updatePlacard(version,id,gameId,serverZoneId,serverId){
				...
				$.ajax({
					url: '<%=request.getContextPath()%>/manage/gm/xyj/placard/findByPlacardId?id='+id+'&gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId, 
					type: 'GET',
			...
			function delPlacard(id,gameId,serverZoneId,serverId){
				if(confirm("该操作会删除。。。。！"))
				    {
							$.ajax({
								url: '<%=request.getContextPath()%>/manage/gm/xyj/placard/del?id='+id+'&gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId, 
								type: 'DELETE',
								contentType: "application/json;charset=UTF-8",
								dataType: 'json',
								success: function(data){
