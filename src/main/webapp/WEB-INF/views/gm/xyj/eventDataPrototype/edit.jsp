...
<html>
<head>
	<title>活动条目修改：（条目Id：${eventDataPrototype.eventDataId}）</title>
...
<body>
	<div class="page-header">
   		<h4>活动条目修改：（条目Id：${eventDataPrototype.eventDataId}）</h4>
 	</div>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/gm/xyj/eventDataPrototype/update"   enctype="multipart/form-data" >
			...
			<div class="row">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="group" id="group" class="input-large " value="${eventDataPrototype.group}" placeholder="如：1" ${eventPrototype.eventType == 13 ? '' : 'readonly="readonly"' }  />
						</div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="eventDataName" id="eventDataName" class="input-large " value="${eventDataPrototype.eventDataName}" placeholder="最多输入8个汉字" ${eventPrototype.eventType == 13 ? '' : 'readonly="readonly"' } />
						</div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="vipMin" id="vipMin" class="input-large " value="${eventDataPrototype.vipMin}" placeholder="如：1"/>
						</div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="vipMax" id="vipMax" class="input-large " value="${eventDataPrototype.vipMax}" placeholder="如：100"/>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="eventDataTimes" id="eventDataTimes" class="input-large " value="${eventDataPrototype.eventDataTimes}" placeholder="单位小时，如：1"/>
						</div>
					</div>
				</div>
				<div class="span6">
				...
				<div class="span12">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="eventDataDes" id="eventDataDes" class="input-large " value="${eventDataPrototype.eventDataDes}" placeholder="最多输入20个汉字"/>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="controls">
							<select name="eventCondition" id="eventCondition">	
								...
								<c:forEach items="${eventDataPrototypeInstructions}" var="item" >
										<option value="${item.id }" ${eventDataPrototype.eventCondition == item.id ? 'selected' : '' }>
											${item.eventCondition}
										</option>
								</c:forEach>
							</select>	
			...
			<c:forEach items="${eventRewardsMap}" var="item" varStatus="i">
				<c:if test="${(i.index) == 0}">
					<div class="row" id="rewards">
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="eventRewards" id="eventRewards" class="input-large eventRewards" value="${item.key}"  placeholder="如：1"/>
								</div>
							</div>
						</div>
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="eventRewardsNum" id="eventRewardsNum" class="input-large eventRewardsNum" value="${item.value}"  placeholder="如：1"/>
								</div>
							</div>
						</div>
						<div class="span3">
