...
<body>
	...
	<div >
		...
		<div>
			...
			<form id="queryForm" class="form-horizontal"  method="get" action="${ctx}/manage/gm/xyj/email/index">
		...
		<div class="control-group">
								...
								<td>
			   					...
			   					<td>
									<div class="action-buttons">
										<shiro:hasAnyRoles name="admin,xyj_gm_email_update"> 
										...
										<shiro:hasAnyRoles name="admin,xyj_gm_email_delete"> 
				...
				<div class="form-actions">
					<shiro:hasAnyRoles name="admin,xyj_gm_email_add">
						<a href="${ctx}/manage/gm/xyj/email/add" class="btn btn-primary">新增邮件</a>
					</shiro:hasAnyRoles>
				</div>
		</div>
		...
		<form id="inputForm" method="post" Class="form-horizontal" action="<%=request.getContextPath()%>/manage/gm/xyj/email/update"   enctype="multipart/form-data"  style="display: none;">
	...
	<script type="text/javascript">
			...
			function updateEmail(sender,title,contents,id,gameId,serverZoneId,serverId){
				...
				$.ajax({
					url: '<%=request.getContextPath()%>/manage/gm/xyj/email/findByEmailId?id='+id+'&gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId, 
					type: 'GET',
			...
			function delEmail(id,gameId,serverZoneId,serverId){
				if(confirm("该操作会删除。。。。！"))
				    {
							$.ajax({
								url: '<%=request.getContextPath()%>/manage/gm/xyj/email/del?id='+id+'&gameId='+gameId+'&serverZoneId='+serverZoneId+'&serverId='+serverId, 
								type: 'DELETE',
								contentType: "application/json;charset=UTF-8",
								dataType: 'json',
								success: function(data){
