...
public class KdsPayConversionScheduled {
	...
	private static final String bulk_type_money_add = "kds_money_add";
	
	private static final String bulk_type_money_all = "kds_money_all";
	
	private static final String bulk_type_money_day = "kds_money_day";
	
	private static final String bulk_type_money_week = "kds_money_week";
