...
public class KdsUserActiveScheduled {
	
	@Autowired
	public Client client;
	
	private static final Logger logger = LoggerFactory.getLogger(KdsUserActiveScheduled.class);
	...
	private static final String bulk_type_active_day = "kds_user_active_day";
	
	private static final String bulk_type_active_week = "kds_user_active_week";
	
	private static final String bulk_type_active_mouth = "kds_user_active_mouth";
