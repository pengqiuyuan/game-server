...
public class FbUserIncomeScheduled {
	...
	private static final Logger logger = LoggerFactory.getLogger(FbUserIncomeScheduled.class);
	...
	private static final String bulk_type_money_sum_total = "fb_money_income_sum_total";
