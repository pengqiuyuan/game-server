...
public class XyjPayConversionScheduled {
	
	@Autowired
	public Client client;
	
	private static final Logger logger = LoggerFactory.getLogger(XyjPayConversionScheduled.class);
	...
	private static final String bulk_index_money = "log_xyj_money";
	
	private static final String bulk_type_money_add = "xyj_money_add";
	
	private static final String bulk_type_money_all = "xyj_money_all";
	
	private static final String bulk_type_money_day = "xyj_money_day";
	
	private static final String bulk_type_money_week = "xyj_money_week";
	
	private static final String bulk_type_money_mouth = "xyj_money_mouth";
	...
	public void schedual() throws Exception{
		logger.info("----------------xyj pay conversion begin--------------");
		try {
			esAll();
		} catch (Exception e) {
			// TODO: handle exception
			logger.error("xyj all pay conversion error "+e);
		}
		...
		try {
			...
			// TODO: handle exception
			logger.error("xyj serverZone pay conversion error "+e);
		}
		...
		try {
			...
			// TODO: handle exception
			logger.error("xyj platForm pay conversion error "+e);
		}
		...
		try {
			...
			// TODO: handle exception
			logger.error("xyj server pay conversion error "+e);
		}

		logger.info("----------------xyj pay conversion end----------------- ");
	}
