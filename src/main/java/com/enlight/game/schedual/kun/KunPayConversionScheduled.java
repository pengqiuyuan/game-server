...
public class KunPayConversionScheduled {
	
	@Autowired
	public Client client;
	
	private static final Logger logger = LoggerFactory.getLogger(KunPayConversionScheduled.class);
	...
	private static final String bulk_type_money_add = "kun_money_add";
	
	private static final String bulk_type_money_all = "kun_money_all";
	
	private static final String bulk_type_money_day = "kun_money_day";
	
	private static final String bulk_type_money_week = "kun_money_week";
