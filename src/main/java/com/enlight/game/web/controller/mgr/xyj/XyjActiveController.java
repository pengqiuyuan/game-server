...
@Controller("XyjActiveController")
@RequestMapping("/manage/xyjActive")
public class XyjActiveController extends BaseController{
	
	private static final Logger logger = LoggerFactory.getLogger(XyjActiveController.class);
	...
	private static final String type_active_day = "xyj_user_active_day";
	
	private static final String type_active_week = "xyj_user_active_week";
	
	private static final String type_active_mouth = "xyj_user_active_mouth";
	 ...
	 */
	@RequiresRoles(value = { "admin", "XYJ_OFF_USER_ACTIVE" }, logical = Logical.OR)
	@RequestMapping(value = "/xyj/userActive", method = RequestMethod.GET)
