...
@Controller("XyjUserPayController")
@RequestMapping("/manage/xyjUserPay")
public class XyjUserPayController extends BaseController{
	
	private static final Logger logger = LoggerFactory.getLogger(XyjUserPayController.class);
	...
	private static final String index_money = "log_xyj_money";
	
	private static final String type_add = "xyj_money_add";
	
	private static final String type_all = "xyj_money_all";
	
	private static final String type_day = "xyj_money_day"; //首日付费率
	
	private static final String type_week = "xyj_money_week"; //首周付费率
	
	private static final String type_mouth = "xyj_money_mouth"; //首月付费率
	 ...
	 */
	@RequiresRoles(value = { "admin", "XYJ_OFF_USER_PAY" }, logical = Logical.OR)
	@RequestMapping(value = "/xyj/userPay", method = RequestMethod.GET)
	 ...
	 */
	@RequiresRoles(value = { "admin", "XYJ_OFF_USER_PAY" }, logical = Logical.OR)
	@RequestMapping(value = "/xyj/userDay", method = RequestMethod.GET)
	 ...
	 */
	@RequiresRoles(value = { "admin", "XYJ_OFF_USER_PAY" }, logical = Logical.OR)
	@RequestMapping(value = "/xyj/userWeek", method = RequestMethod.GET)
	 ...
	 */
	@RequiresRoles(value = { "admin", "XYJ_OFF_USER_PAY" }, logical = Logical.OR)
	@RequestMapping(value = "/xyj/userMouth", method = RequestMethod.GET)
