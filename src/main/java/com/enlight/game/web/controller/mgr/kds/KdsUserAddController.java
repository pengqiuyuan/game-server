...
@Controller("KdsUserAddController")
@RequestMapping("/manage/kdsUserAdd")
public class KdsUserAddController extends BaseController{
	
	private static final Logger logger = LoggerFactory.getLogger(KdsUserAddController.class);
	...
	private static final String type_add = "kds_user_add";
	
	private static final String type_total = "kds_user_total";
	 ...
	 */
	@RequiresRoles(value = { "admin", "KDS_OFF_USER_ADD" }, logical = Logical.OR)
	@RequestMapping(value = "/kds/userAdd", method = RequestMethod.GET)
