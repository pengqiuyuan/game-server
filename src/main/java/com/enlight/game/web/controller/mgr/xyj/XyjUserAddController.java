...
@Controller("XyjUserAddController")
@RequestMapping("/manage/xyjUserAdd")
public class XyjUserAddController extends BaseController{
	
	private static final Logger logger = LoggerFactory.getLogger(XyjUserAddController.class);
	...
	private static final String type_add = "xyj_user_add";
	
	private static final String type_total = "xyj_user_total";
	 ...
	 */
	@RequiresRoles(value = { "admin", "XYJ_OFF_USER_ADD" }, logical = Logical.OR)
	@RequestMapping(value = "/xyj/userAdd", method = RequestMethod.GET)
