...
@Controller("XyjMoneyPayPController")
@RequestMapping("/manage/xyjMoneyPayP")
public class XyjMoneyPayPController extends BaseController{
	
	private static final Logger logger = LoggerFactory.getLogger(XyjMoneyPayPController.class);
	...
	private static final String index = "log_xyj_money";
	
	private static final String type_money_arpu_day = "xyj_money_arpu_day";
	
	private static final String type_money_arpu_mouth = "xyj_money_arpu_mouth";
	
	private static final String type_money_arppu_day = "xyj_money_arppu_day";
	
	private static final String type_money_arppu_mouth = "xyj_money_arppu_mouth";
	 ...
	 */
	@RequiresRoles(value = { "admin", "XYJ_OFF_USER_INCOME" }, logical = Logical.OR)
	@RequestMapping(value = "/xyj/moneyPayP", method = RequestMethod.GET)
