...
@Controller("XyjIncomeController")
@RequestMapping("/manage/xyjIncome")
public class XyjIncomeController extends BaseController{
	
	private static final Logger logger = LoggerFactory.getLogger(XyjIncomeController.class);
	...
	private static final String type_income_sum = "xyj_money_income_sum";
	
	private static final String type_income_sum_total = "xyj_money_income_sum_total";
	
	private static final String type_income_count = "xyj_money_income_count";
	
	private static final String type_income_peoplenum = "xyj_money_income_peoplenum";
	...
	@RequestMapping(value = "/xyj/userIncome", method = RequestMethod.GET)
